...
// multiple use cases
// combine them together testing July 7th 2017
...
javascript:(function () {
    ...
    if ((secondLevelLocation.length === 6 )) {
...
// add mutiple cases for contributor
...
javascript:(function () {
    ...
    n = "https://copilot.aws.conde.io/wrd/articles/" + o
        ...
        ((secondLevelLocation.length === 6 )) {
        n = "https://copilot.aws.conde.io/wrd/contributors/" + c
            } else if {
            ((secondLevelLocation.length === 7 )) {
